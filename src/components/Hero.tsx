      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto lg:mx-0 animate-slide-up" style={{ animationDelay: "0.1s" }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 mb-12 animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-primary/15 rounded-full blur-xl animate-pulse-soft" style={{ animationDelay: "1s" }} />
          </div>
        </div>
        
        {/* Trust Indicators */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto mt-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
